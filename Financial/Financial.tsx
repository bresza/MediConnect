    ...
    return (
      <div className={styles.chartEmptyState}>
        <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          <rect x="6" y="30" width="8" height="16" rx="2" fill="currentColor" opacity="0.15"/>
          <rect x="18" y="22" width="8" height="24" rx="2" fill="currentColor" opacity="0.15"/>
          <rect x="30" y="16" width="8" height="30" rx="2" fill="currentColor" opacity="0.15"/>
          <rect x="42" y="10" width="8" height="36" rx="2" fill="currentColor" opacity="0.15"/>
          <path d="M4 48h48" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" opacity="0.3"/>
          <circle cx="28" cy="20" r="7" fill="currentColor" opacity="0.08"/>
          <path d="M25 20h6M28 17v6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" opacity="0.4"/>
        </svg>
        <p className={styles.chartEmptyTitle}>Sem dados para exibir</p>
        <p className={styles.chartEmptySub}>Os lançamentos aparecerão aqui conforme forem cadastrados.</p>
      </div>
    )
  }
