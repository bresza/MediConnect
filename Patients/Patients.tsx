                    ...
                    <tr key={p.id} className={styles.clickableRow} onClick={() => onViewProfile?.(p)}>
                      ...
                      <td className={`${styles.td} ${isLast ? styles.tdLast : ""}`}>
                        <div className={styles.actions} onClick={(e) => e.stopPropagation()}>
                          <button className={styles.iconBtn} onClick={() => onEditPatient(p)} title="Editar paciente" aria-label="Editar paciente"><EditIcon /></button>
                          {onViewProfile && (
                            <button className={styles.iconBtn} onClick={(e) => { e.stopPropagation(); onViewProfile(p) }} title="Ver prontuário" aria-label="Ver prontuário"><FileIcon /></button>
                          )}
                          {onDeletePatient && (
                            <button className={`${styles.iconBtn} ${styles.iconBtnDanger}`} onClick={() => setConfirmId(p.id)} title="Remover paciente" aria-label="Remover paciente"><TrashIcon /></button>
                          )}
                        </div>
                      </td>
                    </tr>
